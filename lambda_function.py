...
def lambda_handler(event, context):
    try:
        ...
        SUCCESS RULE: ONLY if you successfully answered the user's question using the documents, you must provide exactly two logical follow-up questions at the very end of your response. Format them exactly like this on a new line:
